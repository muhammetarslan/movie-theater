    ...
    public static void main(String[] args) {
        ...
        try {
            while (true) {
                ...
                System.out.println("Type \"json\" to get the result in json format. " +
                        "Any other entry will print the result in a text format");
                String isJson = scanner.nextLine();
                if (isJson.equals("json")) {
